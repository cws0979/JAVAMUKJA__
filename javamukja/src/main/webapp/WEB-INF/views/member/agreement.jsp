...
<body>
<div class="container">
<h3 class="mb-4" style="color: #fac564;">약관동의</h3>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
  <textarea rows="20" cols="800" id="content" name="content" class="form-control" style="color: #212529;">
...
<div class="form-group">
 ...
 name="agree" value="1" ><label for="agree" style="color: #fac564">약관에 동의합니다</label>
 <button class="btn btn-white btn-outline-white">회원가입</button>
 <button class="btn btn-white btn-outline-white" onclick="history.back()">취소</button>
 </div>
</div>
</form>
</div>
